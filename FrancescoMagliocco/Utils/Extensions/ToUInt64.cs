...
namespace FrancescoMagliocco.Utils.Extensions
{
    ...
    /// <summary>
    ///     Class handling all extensionsn involving parsing to <see cref="ulong"/>.
    /// </summary>
    public static class ToUInt64
    {
        #region Members
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="byte"/> to an <see cref="ulong"/> successfully as the
        ///     <see cref="byte.MaxValue"/> is lower than that of an <see cref="ulong"/>.
        /// </summary>
        ...
        /// <returns>
        ///     If successful, returns the given <paramref name="source"/> <see cref="byte"/> parsed to an <see cref="ulong"/>;
        ...
        public static ulong ToULong(this byte source,
                                    ...
                                    ulong defaultValue = 0) => _ToULong(source, numberStyles, provider, defaultValue);

        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="char"/> to an <see cref="ulong"/> successfully as the
        ///     <see cref="char.MaxValue"/> is lower than that of an <see cref="ulong"/>.
        /// </summary>
        ...
        /// <param name="defaultValue"> The default value to be returned if parse failes. </param>
        /// <returns>
        ///     If successful, returns the given <paramref name="source"/> <see cref="char"/> parsed to an <see cref="ulong"/>;
        ///     otherwise returns if specified <paramref name="defaultValue"/> of if not 0UL.
        /// </returns>
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="uint"/> to an <see cref="ulong"/> successfully as the
        ///     <see cref="uint.MaxValue"/> is lower than that of an <see cref="ulong"/>.
        /// </summary>
        ...
        /// <param name="defaultValue"> The default value to be returned if parse failes. </param>
        /// <returns>
        ///     If successful, returns the given <paramref name="source"/> <see cref="uint"/> parsed to an <see cref="ulong"/>;
        ///     otherwise returns if specified <paramref name="defaultValue"/> of if not 0UL.
        /// </returns>
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="ushort"/> to an <see cref="ulong"/> successfully as
        ///     the <see cref="ushort.MaxValue"/> is lower than that of an <see cref="ulong"/>.
        /// </summary>
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="decimal"/> to an <see cref="ulong"/> with a posibility
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="double"/> to an <see cref="ulong"/> with a posibility
        ///     of failing as the <see cref="double.MinValue"/> is lower than that of an <see cref="ulong"/>.
        /// </summary>
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="float"/> to an <see cref="ulong"/> with a posibility
        ///     of failing as the <see cref="float.MaxValue"/> and <see cref="float.MinValue"/> are higher and lower than that of
        ///     an <see cref="ulong"/>.
        /// </summary>
        ...
        /// <param name="defaultValue"> The default value to be returned if parse failes. </param>
        /// <returns>
        ///     If successful, returns the given <paramref name="source"/> <see cref="float"/> parsed to an <see cref="ulong"/>
        ///     ; otherwise returns if specified <paramref name="defaultValue"/> of if not 0UL.
        /// </returns>
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from an <see cref="int"/> to an <see cref="ulong"/> with a posibility of
        ///     failing as the <see cref="int.MinValue"/> is lower than that of an <see cref="ulong"/>.
        /// </summary>
        ...
        /// <param name="defaultValue"> The default value to be returned if parse failes. </param>
        /// <returns>
        ///     If successful, returns the given <paramref name="source"/> <see cref="int"/> parsed to an <see cref="ulong"/>;
        ///     otherwise returns if specified <paramref name="defaultValue"/> of if not 0UL.
        /// </returns>
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="long"/> to an <see cref="ulong"/> with a posibility of
        ///     failing as the <see cref="long.MinValue"/> is lower than that of an <see cref="ulong"/>.
        /// </summary>
        ...
        /// <param name="defaultValue"> The default value to be returned if parse failes. </param>
        /// <returns>
        ///     If successful, returns the given <paramref name="source"/> <see cref="long"/> parsed to an <see cref="ulong"/>;
        ///     otherwise returns if specified <paramref name="defaultValue"/> of if not 0UL.
        /// </returns>
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="object"/> to an <see cref="ulong"/> with a posibility
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="sbyte"/> to an <see cref="ulong"/> with a posibility
        ///     of failing as the <see cref="sbyte.MinValue"/> is lower than that of an <see cref="ulong"/>.
        /// </summary>
        ...
        /// <param name="defaultValue"> The default value to be returned if parse failes. </param>
        /// <returns>
        ///     If successful, returns the given <paramref name="source"/> <see cref="sbyte"/> parsed to an <see cref="ulong"/>;
        ///     otherwise returns if specified <paramref name="defaultValue"/> of if not 0UL.
        /// </returns>
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="short"/> to an <see cref="ulong"/> with a posibility
        ///     of failing as the <see cref="short.MinValue"/> is lower than that of an <see cref="ulong"/>.
        /// </summary>
        /// <param name="source"> The source <see cref="sbyte"/> to be parsed to an <see cref="ulong"/>. </param>
        /// <param name="numberStyles">
        ///     <para>
        ...
        /// <param name="defaultValue"> The default value to be returned if parse failes. </param>
        /// <returns>
        ///     If successful, returns the given <paramref name="source"/> <see cref="short"/> parsed to an <see cref="ulong"/>;
        ///     otherwise returns if specified <paramref name="defaultValue"/> of if not 0UL.
        /// </returns>
        ...
        /// <summary>
        ///     Parses the given <paramref name="source"/> from a <see cref="string"/> to an <see cref="ulong"/> with a posibility
